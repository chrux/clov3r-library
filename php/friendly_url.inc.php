...
function generate_seo_link($input,$replace = '-',$len=64,$remove_words = true) {
  ...
  // Replace vowel with accent without them and also rare characters
  // No accepted chars
  $na_chars = array(
    '/[áàâãªÁÀÂÃ]/u',
    '/[éèêÉÈÊ]/u',
  ...
  // third, delete repeated whitespace in the string and , fourth delete whitespace at the
  // end and begin, fifth truncate string to $len
